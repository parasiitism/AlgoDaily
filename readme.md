...
| 153 | [Top K Frequent Words](/leetcode/692-top-k-frequent-words/) | hashtable, bucket sort | [leetcode 692](https://leetcode.com/problems/top-k-frequent-elements/) | 1st O(2nlogn) beats 25%. 2nd O(nlogn) beats 100%. takeaway: sort things with priority queue using priority WITH other params |
| 153 | [Sort Characters By Frequency](/leetcode/451-sort-characters-by-frequency/) | hashtable, bucket sort | [leetcode 692](https://leetcode.com/problems/sort-characters-by-frequency/) | 1st O(n) beats 66% |