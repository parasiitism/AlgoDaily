...
| 500 | [Decompress Run-Length Encoded List](/leetcode/1313-decompress-run-length-encoded-list) | array | [leetcode 1289](https://leetcode.com/problems/decompress-run-length-encoded-list/) | very bad description |