...
| 493 | [Minimum Falling Path Sum](/leetcode/931-minimum-falling-path-sum) | dynamic programming | [leetcode 931](https://leetcode.com/problems/minimum-falling-path-sum/) | 1st recursion + hashtable O(RC). 2nd bottpm up matrix O(RC) 📌 |
