...
| 190 | [Basic Calculator II](/leetcode/227-basic-calculator-ii) | string, queue, stack | [leetcode 227](https://leetcode.com/problems/basic-calculator-ii/) | 1st O(2n), takeaway: `isdigit()` and `isinstance(a, int)` for type checking, 2nd O(2n) too but more concise |