...
| 282 | [Partition Equal Subset Sum](/leetcode/416-partition-equal-subset-sum) | dynamic programming | [leetcode 416](https://leetcode.com/problems/partition-equal-subset-sum/) | 📌📌📌classic dp, "the easiest NP-hard problem" 1st O(NS) top-down recursion + hashtable |