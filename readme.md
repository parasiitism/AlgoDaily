...
| 152 | [Top K Frequent Elements](/leetcode/347-top-k-frequent-elements/) | hashtable, array | [leetcode 347](https://leetcode.com/problems/top-k-frequent-elements/) | 1st O(nlogn) beats 64%. 2nd O(n) beats 64%. takeaway: bucket sort for `frequency` questions |
| 153 | [Top K Frequent Words](/leetcode/692-top-k-frequent-words/) | hashtable, array | [leetcode 692](https://leetcode.com/problems/top-k-frequent-elements/) | 1st O(nlogn) beats 25%. takeaway: bucket sort for `frequency` questions |