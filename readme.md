...
| 202 | [Construct Binary Tree from String](/leetcode/536-construct-binary-tree-from-string) | tree, recursion | [leetcode 536](https://leetcode.com/problems/construct-binary-tree-from-string/)| O(n) recursive dfs |