...
| 207 | [Linked List Random Node](/leetcode/382-linked-list-random-node) | linked list | [leetcode 382](https://leetcode.com/problems/linked-list-random-node/) | 1st naive O(n)O(1), 2nd O(1)O(n) |