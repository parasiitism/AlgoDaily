...
| 183 | [Sort Colors](leetcode/75-sort-colors/) | bucket | [leetcode 75](https://leetcode.com/problems/sort-colors/) | 0th merge sort O(nlogn), 1st bucket sort O(2n), 2nd moving zeros/twos swap O(2n)  |